          ...
          <div className="space-y-4">
            ...
            <div className="text-sm">
              ...
              <div className="text-neutral-100 font-medium">
                ${previewData.currentPlan.amount / 100}/mo
              </div>
            </div>
            ...
            <div className="text-sm">
              ...
              <div className="text-neutral-100 font-medium">
                ${previewData.newPlan.amount / 100}/mo
              </div>
            </div>
            ...
            <div className="pt-4">
              {previewData.proration.credit > 0 && (
                <div className="flex justify-between text-sm mb-2">
                  ...
                  <span className="text-emerald-400">
                    -${previewData.proration.credit.toFixed(2)}
                  </span>
                </div>
              )}
              {previewData.proration.charge > 0 && (
                <div className="flex justify-between text-sm mb-2">
                  ...
                  <span className="text-neutral-100">
                    ${previewData.proration.charge.toFixed(2)}
                  </span>
                </div>
              )}
              ...
              <div className="flex justify-between text-sm font-medium pt-2">
                ...
                <span
                  className={
                    previewData.proration.immediatePayment > 0
                      ? "text-neutral-100"
                      : "text-emerald-400"
                  }
                >
            ...
            {previewData.proration.nextBillingDate && (
              <div className="text-xs text-neutral-400">
                ...
                {new Date(previewData.proration.nextBillingDate).toLocaleDateString()}
              </div>
            )}
