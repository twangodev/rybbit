...
function FeatureCell({ value, isPro = false }) {
  ...
  return (
    <span className={cn(
      ...
      isPro ? "text-emerald-400 font-medium" : "text-neutral-300"
    )}>
      {value}
    </span>
  );
    ...
    <section className="py-16 w-full">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="w-full border border-neutral-800/50 rounded-lg overflow-hidden">
          {/* Table Header */}
          <div className="grid grid-cols-3 gap-0 py-4 border-b-2 border-neutral-600 bg-neutral-800/20">
            <div className="flex items-center px-6 border-r border-neutral-700/50">
              <span className="font-medium text-neutral-200 text-lg">Features</span>
            </div>
            <div className="flex flex-col items-center justify-center px-6 border-r border-neutral-700/50">
              ...
              <div className="text-sm text-neutral-400 text-center">$0/month</div>
            </div>
            <div className="flex flex-col items-center justify-center px-6">
              <div className="font-semibold text-lg text-emerald-400 text-center">Pro</div>
              <div className="text-sm text-neutral-400 text-center">Starting at $19/month</div>
            </div>
          </div>
        ...
        {/* CTA Section */}
        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-12 pt-8 border-t border-neutral-700">
          <a
            href="https://app.rybbit.io/signup"
            className="inline-flex items-center justify-center px-6 py-3 bg-neutral-700 hover:bg-neutral-600 text-white font-medium rounded-lg border border-neutral-600 transform hover:-translate-y-0.5 transition-all duration-200"
          >
            Start Free
          </a>
          <a
            href="https://app.rybbit.io/signup"
            className="inline-flex items-center justify-center px-6 py-3 bg-emerald-600 hover:bg-emerald-500 text-white font-medium rounded-lg shadow-lg shadow-emerald-900/20 transform hover:-translate-y-0.5 transition-all duration-200"
          >
            Try Pro Free
          </a>
        </div>
