...
export default async function Image(props) {
  ...
  try {
    ...
    console.log("Could not load page metadata for OG image:", error);
  }
      ...
      >
        ...
        <div
          style={{
            ...
            height: "300px",
            borderRadius: "50%",
            background: "linear-gradient(45deg, #22c55e20, #3b82f620)",
            filter: "blur(60px)",
          }}
        />
        <div
          style={{
            ...
            height: "400px",
            borderRadius: "50%",
            background: "linear-gradient(135deg, #8b5cf620, #22c55e20)",
            filter: "blur(80px)",
          }}
        />
      </div>
