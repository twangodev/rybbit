...
You'll need to configure your web server to proxy requests to the Next.js client service. Here's an example Nginx configuration:
...
server {
    ...
    # Proxy all requests to Next.js client - adjust port if you customized it
    location / {
