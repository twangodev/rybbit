...
{% if jekyll.environment == "production" and site.rybbit_site_id %}
  <script async defer src="{{ site.rybbit_instance_url | default: 'https://your-rybbit-instance.com' }}/script.js" data-site-id="{{ site.rybbit_site_id }}"></script>
{% endif %}
{{% endraw %}}
```
...
rybbit_instance_url: "https://your-rybbit-instance.com" # Optional, defaults in include
