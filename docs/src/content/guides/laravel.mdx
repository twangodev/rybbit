...
```html
<script async defer src="https://your-rybbit-instance.com/script.js" data-site-id="YOUR_SITE_ID"></script>
```

Replace `https://your-rybbit-instance.com` with the URL of your Rybbit instance and `YOUR_SITE_ID` with the actual Site ID from your Rybbit dashboard.
...
<body class="font-sans antialiased">
    ...
    @if(app()->environment('production'))
        <script async defer src="{{ config('services.rybbit.instance_url', 'https://your-rybbit-instance.com') }}/script.js" data-site-id="{{ config('services.rybbit.site_id') }}"></script>
    @endif
</body>
</html>
```
...
- `{{ config('services.rybbit.instance_url', 'https://your-rybbit-instance.com') }}` and `{{ config('services.rybbit.site_id') }}`: This is a recommended way to manage your Rybbit credentials using Laravel's configuration system. See step 4.
...
```env
RYBBIT_INSTANCE_URL=https://your-rybbit-instance.com
