...
{{ if and (not .Site.IsServer) .Site.Params.rybbitSiteID }}
  <script async defer src="{{ .Site.Params.rybbitInstanceURL | default "https://your-rybbit-instance.com" }}/script.js" data-site-id="{{ .Site.Params.rybbitSiteID }}"></script>
{{ end }}
```
...
```toml
[params]
  rybbitInstanceURL = "https://your-rybbit-instance.com" # Your Rybbit instance URL
