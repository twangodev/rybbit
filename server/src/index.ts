...
import { getSearchConsoleData } from "./api/analytics/searchConsole/getSearchConsoleData.js";
...
import { getSearchConsoleApiKey } from "./api/sites/getSearchConsoleApiKey.js";
import { updateSearchConsoleApiKey } from "./api/sites/updateSearchConsoleApiKey.js";
import { generateOAuthUrl, handleOAuthCallback, disconnectSearchConsole, getConnectionStatus } from "./api/searchConsole/oauth.js";
import { addSitesFromSearchConsole } from "./api/searchConsole/addSitesFromSearchConsole.js";
import { getSearchConsoleSites } from "./api/searchConsole/getSearchConsoleSites.js";
...
server.get("/api/search-console/:site", getSearchConsoleData);
...
server.get("/api/site/:siteId/search-console-api-key", getSearchConsoleApiKey);
server.post("/api/site/:siteId/search-console-api-key", updateSearchConsoleApiKey);

// Search Console OAuth2 routes
  server.get("/api/site/:siteId/search-console/oauth/url", generateOAuthUrl);
  server.get("/api/search-console/oauth/callback", handleOAuthCallback);
  server.post("/api/site/:siteId/search-console/disconnect", disconnectSearchConsole);
  server.get("/api/site/:siteId/search-console/connection-status", getConnectionStatus);
  server.get("/api/site/:siteId/search-console/sites", getSearchConsoleSites);
  server.post("/api/site/:siteId/search-console/add-sites", addSitesFromSearchConsole);
